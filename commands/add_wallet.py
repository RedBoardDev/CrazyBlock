...
class Add_wallet(commands.Cog):
    ...
    async def add_wallet_cmd(self, ctx, wallet: str, round_share:float, channel: discord.TextChannel, role: discord.Role):
    ...
    async def add_wallet_error(self, ctx, error: commands.CommandError):
        if isinstance(error, commands.ChannelNotFound):
            ...
            await ctx.send('I don''t have permission to write in this room...')
                ...
                await ctx.send('Error: $add_wallet roundshare wallet channel_id role_id')
